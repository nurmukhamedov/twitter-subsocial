...
const FollowItem: React.FC<INewsItem> = ({ image, username, name, url }) => {
	return (
		<div className="px-4 py-3 anim hover:bg-dark-hover cursor-pointer border-b border-gray-100 border-opacity-15">
			<div className="flex">
				<div>
				...
				<div className="flex-grow px-3 items-center">
					...
					<span className="block text-gray-600 text-sm leading-none">@{username}</span>
				</div>
				<a
					href={url}
					target="_blank"
	...
	return (
		<div className="widget">
			<div className="px-4 border-b border-gray-100 border-opacity-15 py-2">
				<span className="text-xl font-bold text-white">Who to follow</span>
			</div>
			<FollowItem
			...
			/>
			<FollowItem
				url="https://twitter.com/mrnurmukhamedov"
				image="/images/personal.jpg"
				name="Abdurasul"
				username="mrnurmukhamedov"
			/>
